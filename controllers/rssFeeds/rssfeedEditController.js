...
define(
  ...
  function(app, httpClient, _) {
    app.RssfeedEditController = Ember.ObjectController.extend({
      ...
      feedExist: function() {
        ...
        var id=feedsController.get('rssFeedId');
        existingFeeds=_.without(existingFeeds,_.findWhere(existingFeeds,{"_id":id}));
