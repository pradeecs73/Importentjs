define(['app', "services/kotg/kotgShareService", "text!templates/kotg/shareTemplete.hbs", "Q"],
    function(App, shareService, shareTemplete, Q) {

        App.KOTGShareMixin = Ember.Mixin.create({
            getUsers: function() {
            ...
            shareCourse: function(ignore, share) {
                ...
                if (sharedWith.length === 0) {
	                ...
	                shareService.shareDocument(documentId, sharedWith, comment).done(function(obj) {
